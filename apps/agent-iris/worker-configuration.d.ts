/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a736923e4107383c01766b928d962704)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "http://localhost:5173,http://localhost:4173,http://127.0.0.1:5173,https://frontend.aureline.workers.dev";
	IrisAgent: DurableObjectNamespace<import("./src/index").IrisAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IrisAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PLANNER_MODEL" | "VISION_PLANNER_MODEL" | "IMAGE_MODEL" | "AI_GATEWAY_ID" | "RETENTION_LIMIT" | "MAX_RETRIES" | "MAX_RESUME_ATTEMPTS" | "RESEARCH_MODEL" | "MAX_TOOL_ITERATIONS" | "MAX_SEARCH_RESULTS" | "MIN_CHUNK_CHARS" | "SEARCH_MATCH_THRESHOLD" | "AI_SEARCH_QUERY_REWRITE" | "ALLOWED_ORIGINS">> {}
}
