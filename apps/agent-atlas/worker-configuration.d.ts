/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9d7c92abf14e33570ef6ff9a7525a59a)
...
interface __BaseEnv_Env {
	...
	AtlasAgent: DurableObjectNamespace<import("./src/index").AtlasAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "AtlasAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "IMAGE_MODEL" | "AI_GATEWAY_ID" | "RETENTION_LIMIT" | "MAX_RETRIES" | "MAX_RESUME_ATTEMPTS" | "ALLOWED_ORIGINS">> {}
}
