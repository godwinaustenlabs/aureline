 ...
 *
 * **This file is a near-copy of `apps/agent-iris/src/http.ts`, deliberately.**
 * Shared code belongs in `packages/shared-utils`, which `atlas-07` freezes
 * while Atlas is mid-sprint, and each engine is independently deployable by
 * design (AGENTS.md §1). Fold the two together when that freeze lifts — and
 * until then, a change here is a change there.
 */
